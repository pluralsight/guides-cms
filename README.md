...
[hack.guides()](http://hackguides.org) is a CMS based on Markdown and Github written by-developers, for-developers.  The CMS is open-source (this repo), and all articles are also stored in an open-source Github repo.  The content can be visualized here.
...
hack.guides() is subsidized by Pluralsight.
